...
add_action('wp_enqueue_scripts', function () {
    ...
    if (
        ...
        is_array(wp_remote_get('http://node:5173/'))
    ) {
        $viteServerAddr = 'http://0.0.0.0:5173/';
        wp_enqueue_script('vite', "{$viteServerAddr}@vite/client");
        wp_enqueue_script('wordplate', "{$viteServerAddr}resources/js/index.js");
